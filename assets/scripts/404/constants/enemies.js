export const enemiesData = {
  ...
  "FOUND": {
    ...
    "attackInterval": [5000, 7000]
  },
  "ERROR": {
    "name": "ERROR",
    "stages": [4, 5, 6, 9],
    "attackType": "scatter", // 8方向への拡散弾
    "attackInterval": [8000, 12000]
  },
  // ステージ 6 ~ 10
  "DENIED": {
    "name": "DENIED",
    ...
    "attackInterval": [10000, 15000] // Changed to 10-15s
  },
  "ACCESS": {
    "name": "ACCESS",
    "stages": [8, 9, 10],
    "attackType": "aimed_laser", // 2秒間、パドルの位置を狙ったレーザーポイントを行い、 1秒間その位置で固定、 その位置をレーザー射撃 (レーザーポイント・射撃中は移動しない)
    "attackInterval": [12000, 18000] // Changed to 12-18s
  },
  "FORBIDDEN": {
    "name": "FORBIDDEN",
    "stages": [9, 10],
    "attackType": "mud", // 落下してm u dに分離、当たると移動速度低下
    "attackInterval": [6000, 9000] // Changed to 6-9s
  }
};
